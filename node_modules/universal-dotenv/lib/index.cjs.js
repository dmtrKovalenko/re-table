/*! universal-dotenv v1.8.2 by Sebastian Software <s.werner@sebastian-software.de> */
'use strict';
...
var NODE_ENV = process.env.NODE_ENV,
    ...
    dotenvFiles = [BUILD_TARGET && dotEnvBase + "." + BUILD_TARGET + "." + NODE_ENV + ".local", BUILD_TARGET && dotEnvBase + "." + BUILD_TARGET + "." + NODE_ENV, BUILD_TARGET && NODE_ENV !== "test" && dotEnvBase + "." + BUILD_TARGET + ".local", BUILD_TARGET && dotEnvBase + "." + BUILD_TARGET, dotEnvBase + "." + NODE_ENV + ".local", dotEnvBase + "." + NODE_ENV, NODE_ENV !== "test" && dotEnvBase + ".local", dotEnvBase].filter(Boolean);
