...
var makeDecorator = exports.makeDecorator = function makeDecorator(_ref) {
  var name = _ref.name,
      ...
      allowDeprecatedUsage = _ref$allowDeprecatedU === undefined ? false : _ref$allowDeprecatedU;
  ...
  return function () {
    ...
    return function () {
      ...
      throw new Error('Passing stories directly into ' + name + '() is not allowed, instead use addDecorator(' + name + ') and pass options with the \'' + parameterName + '\' parameter');
    };
  };
